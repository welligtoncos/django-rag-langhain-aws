"""
Django settings for my_project_ia_rag_aws project.
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'API RAG - LangChain AWS',
    'DESCRIPTION': 'Sistema RAG com LangChain e AWS',
    'VERSION': '1.0.0',
...
# 📂 CONFIGURAÇÃO DE ARQUIVOS STATIC
STATIC_ROOT = BASE_DIR / 'staticfiles'

# 📸 CONFIGURAÇÃO DE ARQUIVOS MEDIA
MEDIA_URL = '/media/'
